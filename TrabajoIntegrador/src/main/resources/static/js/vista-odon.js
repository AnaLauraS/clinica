window.addEventListener('load', function(){
    ...
    guardar.addEventListener('submit', function(e){
        e.preventDefault();
        const apellidoT=document.querySelector('#input3').value;
        const nombreT=document.querySelector('#input2').value;
        const matriculaT=document.querySelector('#input4').value;
        // valido que no esté vacio
        if (apellidoT !="" & nombreT!="" & matriculaT!=""){
        // tomo los datos
        const formData = {
            apellido: apellidoT,
            nombre: nombreT,
    ...
    guardar2.addEventListener('submit', function(e){
        e.preventDefault();
        const apellidoT=document.querySelector('#input7').value;
        const nombreT=document.querySelector('#input6').value;
        const matriculaT=document.querySelector('#input8').value;
        // valido que no esté vacio
        if (apellidoT !="" & nombreT!="" & matriculaT!=""){
        // tomo los datos
        const formData = {
