window.addEventListener('load', function(){
    ...
    guardar.addEventListener('submit', function(e){
        e.preventDefault();
        const nombreT=document.querySelector('#input3').value;
        const apellidoT=document.querySelector('#input2').value;
        const fechaT=document.querySelector('#input12').value;
        if (nombreT !="" & apellidoT != "" & fechaT !=""){
        // tomo los datos
        const formData = {
            nombre: nombreT,
            apellido: apellidoT,
        ...
        fetch(url, settings)
            ...
            alert("complete los datos minimos (nombre, apellido y fecha de alta)")}
    })
    ...
    guardar2.addEventListener('submit', function(e){
        e.preventDefault();
        const nombreT=document.querySelector('#input7').value;
        const apellidoT=document.querySelector('#input8').value;
        const fechaT=document.querySelector('#input11').value;
        if (nombreT !="" & apellidoT != "" & fechaT !=""){
        // tomo los datos
        const formData = {
